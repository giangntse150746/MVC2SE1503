...
public class TblDemoDAO implements Serializable {
    ...
    public TblDemoDTO checkLogin(String username, String password)
        ...
        try {
            ...
            if (con != null) {
                ...
                if (rs.next()) {
                    ...
                    TblDemoDTO user = new TblDemoDTO(
    ...
    public boolean newRegister(String username, String password, 
        ...
        try {
            ...
            if (con != null) {
                ...
                String sql = "Insert Into "
                            + "TblDemo(username,password,lastname,isAdmin) "
                            + "Values ( ?, ?, ?, ?)";
    ...
    public boolean deleteAccount(String username)
        ...
        try {
            ...
            //4. Execute Query.
            int row = stm.executeUpdate();
            //5. Process Result. (No need object type return)
            if (row > 0) {
                return true;
            }
        }
    ...
    //NOT DONE//
    public String update(String username, String password, String role)
                throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        boolean isAdmin;
